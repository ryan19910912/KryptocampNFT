...
var CoinbaseWalletConnector = class extends Connector {
  ...
  async getProvider() {
    var _a;
    if (!_classPrivateFieldGet(this, _provider)) {
      let CoinbaseWalletSDK = (await import("./dist-LTORZHGT.js")).default;
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-42TN4B4Y.js.map
